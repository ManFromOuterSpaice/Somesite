$(function(){
    ...
    $('.info-tabs__item').on('click',function(e) {
        ...
        $('.info-tabs__item').removeClass('info-tabs__item__active');
        $(this).addClass('info-tabs__item__active');

        $('.info-tabs__content').removeClass('info-tabs__content__active');
        $($(this).attr('href')).addClass('info-tabs__content__active');
